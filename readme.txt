...
For the Links output file the result might be different depending on your product. Use the LinkGen.py file to find out which part of the line variable is the gene length so you can get the correct link files
